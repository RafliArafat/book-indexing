...
OUTPUT_DIR  = r"C:\SKRIPSI (code)\hasil_index_v1_jumlah_sama"
...
pemetaan_ringkasan = {
    "Buku 1":  "Prinsip pengadaan energi listrik, hukum dasar konversi energi elektromagnet, fenomena induksi elektromagnetik (Hukum Faraday), pembangkitan Gaya Gerak Listrik (GGL), serta konsep kopel (torsi). Generator Arus Searah (GDC), Konsep sistem tegangan listrik bolak-balik (AC) tiga fase, Konstruksi fisik dan prinsip kerja motor DC.",
    "Buku 2":  "",
    "Buku 3":  "",
    "Buku 4":  "",
    "Buku 5":  "layanan internet, hingga World Wide Web (WWW), pemanfaatan internet dalam kehidupan dan bisnis, penggunaan email, blog, domain, hyperlink, browser. penggunaan aplikasi Google untuk mendukung aktivitas pendidikan dan bisnis. fitur-fitur Google Apps seperti Gmail, Google Drive, Google Docs, Google Form, Google Sheet, dan Google Calendar. penggunaan Google Dokumen dan Canva sebagai alat pembuatan dokumen dan desain presentasi. membuat formulir online menggunakan Google Form, responden, form builder, survey online, sharing form. Google Sheet untuk pengolahan data Google Calendar untuk mengatur jadwal, agenda, membuat slide presentasi yang menarik dan efektif. canva, infografis, typography. membahas pengenalan Microsoft Excel, worksheet, cell, baris, kolom, spreadsheet, penggunaan fungsi VLOOKUP dan HLOOKUP. penggunaan filter dan pivot table, excel analysis",
    "Buku 6":  "",
    "Buku 7":  "Dijelaskan transformasi biologis, lingkungan biologi, konfigurasi bioreaktor, serta peran mikroorganisme seperti bakteri, archaea, dan eucarya. proses aerobik, anaerobik, anoksik, biomassa. membahas konsep biofilter aerob sebagai metode pengolahan biologis air limbah, sistem filtrasi, biodegradasi. membahas penggunaan teknologi nano dalam proses adsorpsi nanomaterial seperti nano-fotokatalis, nano-membran, nano-adsorben. carbon nanotube (CNT). kolom adsorpsi, Granular Activated Carbon (GAC).",
    "Buku 8":  "",
    "Buku 9":  "sistem kendali digital dalam pengendalian proses modern yang memanfaatkan komputer dan mikrokontroler. konsep dasar sistem kendali, diagram blok, serta cara kerja sistem kendali loop tertutup. feedback, sistem dikrit, sistem kontinyu. proses pemodelan sistem berdasarkan hukum fisik, grafik respon, motor DC, matlab, simulink, orde sistem, boost converter. Dijelaskan proses tuning PID, respon sistem. proses sampling sinyal menggunakan mikrokontroler dan simulasi menggunakan Proteus. pemrograman AVR, ADC, sistem kendali suhu, penggunaan sensor suhu, display LCD, aktuator heater, dan optimasi kontrol.",
    "Buku 10": "",
    "Buku 11": "Konsep dasar sistem kontrol, peran penting instrumentasi, serta definisi proses dan sistem dinamis, perangkat keras kontrol mencakup sensor, transmitter, katup kontrol pengembangan flowsheet. Penyelesaian Persamaan Diferensial Biasa (ODE). Karakteristik respons sistem loop terbuka vs loop tertutup, penggunaan variabel deviasi, analisis respons frekuensi (Plot Bode), Transformasi Laplace dan Fungsi Transfer, representasi Diagram Blok, overdamped, critically damped, underdamped, tidak stabil, dan inverse response.",
    "Buku 12": "",
    "Buku 13": "Konsep dasar teknologi Computer-Aided Design (CAD) dan Computer-Aided Manufacturing (CAM). perangkat lunak Mastercam, Pembuatan desain sketsa 2D (garis, chamfer, fillet), simulasi proses pembubutan yang mencakup roughing, finishing, threading (ulir), grooving (alur), dan cutoff (pemotongan). Dasar-proses milling, pembuatan desain 2D untuk milling dan mesin CNC.",
    "Buku 14": "",
    "Buku 15": "",
    "Buku 16": "Konsep, bentuk, dan tahapan penyusunan Standar Operasional Prosedur (SOP) yang berfokus pada SOP Model Manajemen. Matriks SWOT berupa Strategi SO (Agresif), Strategi ST (Diversifikasi), Strategi WO (Turn-around), dan Strategi WT (Defensif). Implementasi dan perhitungan matriks Internal Factor Analysis Summary (IFAS) dan External Factor Analysis Summary (EFAS). Penentuan posisi strategi dan arah kebijakan TEFA melalui Grafik Kuadran.",
    "Buku 17": "bentuk komunikasi verbal dan nonverbal, komunikasi merupakan proses pertukaran informasi, komunikasi vertikal, horizontal, dan diagonal. Komunikasi bisnis digunakan untuk mendukung aktivitas organisasi, perencanaan dalam penyusunan pesan bisnis, Encoding, feedback, body language, konflik organisasi, konflik fungsional, konflik disfungsional, email, teleconference, media sosial, branding, public relations, media promosi, dan komunikasi digital, pengertian, prinsip, dan proses negosiasi dalam komunikasi bisnis.",
    "Buku 18": "komponen utama motor bakar seperti piston, silinder, poros engkol, dan katup, Titik mati atas (TMA) dan titik mati bawah (TMB), siklus Otto, siklus Diesel, serta siklus Brayton. Prinsip kerja motor bakar empat langkah (4-stroke) dan dua langkah (2-stroke), perbedaan antara motor bakar bensin dan diesel, serta konsep rasio kompresi, efisiensi termal, dan emisi gas buang. reaksi kimia pembakaran, tahapan pembakaran, dan fenomena detonasi, air fuel ratio (AFR) knocking, pembakaran sempurna, istem konvensional, sistem injeksi mekanik, intake manifold, exhaust manifold, karburator, venturi, choke, pelumas, radiator, coolant, pendingin",
    "Buku 19": "",
    "Buku 20": "membahas pengenalan dasar Macromedia Flash Dijelaskan fungsi stage, toolbox, timeline, frame, dan layer, playhead. menggunakan tools pada Flash, seperti oval tool, rectangle tool, dan polystar tool. vector graphic, flash drawing, shape. pengolahan objek grafis seperti pemberian warna, gradasi, dan editing objek, fill color dan stroke color, gradient. pengolahan teks di Flash, termasuk pembuatan static text, dynamic text, dan input text. dijelaskan berbagai efek teks seperti blur, expand, explode, dan drop shadow, typography. membahas teknik animasi frame by frame, membahas teknik motion tweening. pembuatan animasi teks, dynamic text, scrolling text. membahas teknik shape tweening, morphing, teknik masking, mask layer, visual effect, pengelolaan button.",
    "Buku 21": "metode spektrometri sebagai teknik analisis instrumental, spektrum, gugus fungsi, serta interpretasi data hasil analisis spektrometri. engidentifikasi gugus fungsi senyawa organik, jenis ikatan kimia, interpretasi spektrum IR, membahas prinsip dasar kromatografi, Kromatografi Gas (GC) penggunaan Gas Chromatography menggunakan detektor FID, prinsip kerja kromatografi gas, komponen instrumen, teori Van Deemter, kolom, gas pembawa, detektor, serta analisis kromatogram.",
    "Buku 22": "perancangan serta manufaktur perangkat medis Ankle-Foot Orthosis (AFO). penerapan Additive Manufacturing (3D Printing), Pengenalan teknologi Reverse Engineering. Manfaat penggunaan AFO untuk rehabilitasi pasien (seperti penderita cedera pergelangan kaki atau foot drop). pemindaian 3D (3D scanning), pemodelan CAD, analisis elemen hingga (finite element).",
    "Buku 23": "Konsep dasar optimasi, ruang lingkup, struktur hierarki, Dasar-dasar program MATLAB, pengoperasian fungsi matematika, manajemen File dan M-File, penggunaan struktur kontrol Loops, Conditional Statements, Switch-Case degree of freedom. algoritma Metode Newton-Raphson, Metode Simpson’s 1/3 Rule, Pengertian persamaan diferensial, penyelesaian Persamaan Diferensial Biasa (PDB) Metode Runge-Kutta",
    "Buku 24": "",
    "Buku 25": "",
    "Buku 26": "",
    "Buku 27": "sistem televisi analog dan sinyal video analog. Dijelaskan proses scanning gambar, sinkronisasi sinyal, encoding warna, serta sistem warna televisi seperti NTSC, PAL, dan SECAM. Modulasi amplitudo (AM), proses sampling dan kuantisasi, digitalisasi sinyal video dan audio, format digital video, HDTV, ADC, DAC, CIF, QCIF, SIF, kompresi video. Dijelaskan berbagai metode kompresi seperti Discrete Cosine Transform (DCT), Run Length Coding, VLC, Huffman Coding, serta standar MPEG. sistem MPEG dalam proses multipleksing data audio, video, dan informasi lainnya pada televisi digital. Network Information Table (NIT), Service Description Table (SDT).",
    "Buku 28": "konsep dasar hingga strategi penerapan E-Commerce dan E-Business dalam dunia bisnis digital, electronic payment system, membahas hubungan e-commerce dengan UMKM, ekonomi digital, e-business, blog, social site, portal site, hingga aspek hukum, etika internet, tiktok shop, traffic building",
    "Buku 29": "",
    "Buku 30": "",
    "Buku 31": "dasar-dasar Hukum Pidana dan Hukum Perdata, Konsep dasar dan pengertian arsip, tujuan utama pengelolaan kearsipan, pengenalan awal mengenai pengertian legalisasi dokumen, carding cracking cyberstalking, ubungan antara legalisasi dokumen dengan ketercapaian tujuan arsip, pemahaman mendalam mengenai prosedur legalisasi, roses transformasi digitalisasi arsip, jaminan autentisitas dan legalitas hukum arsip hasil digitalisasi, yuridis serta analisis hukum pada studi kasus penerapan Aplikasi Srikandi.",
    "Buku 32": "dasar-dasar hukum dan regulasi dalam sektor telekomunikasi, teknologi telekomunikasi dengan kebijakan pemerintah, konsep regulasi, liberalisasi, privatisasi, dan badan regulator. membahas penerapan hukum persaingan, perjanjian interkoneksi jaringan, berbagi infrastruktur, lisensi, kekayaan intelektual. membahas perkembangan regulasi telekomunikasi, reformasi regulasi. termasuk konvergensi media komunikasi, media sosial, keamanan siber, perlindungan privasi, dan ancaman dunia maya, cyber security, cyber attack, digital regulation, konten digital.",
    "Buku 33": "engineering project design, Pengertian dan filosofi dasar dari metodologi Agile, implementasi Agile, kerangka kerja Scrum, seperti Product Owner, Scrum Master, dan Development Team, seperti Sprint Planning, Daily Standup, Sprint Review, dan Retrospective, Pengenalan JIRA sebagai alat bantu (tool) manajemen proyek berbasis Agile/Scrum, Manajemen backlog dan siklus kerja di JIRA, yang mencakup pembuatan dan pengaturan Sprint, pengelompokan fitur besar melalui Epic Project Pages.",
    "Buku 34": "menjadikan mahasiswa mampu memahami konsep, teknologi, model, dan aplikasi SPK, Metode Weighted Sum Model (WSM), Metode Weighted Product Model (WPM), Metode Analytic Hierarchy Process (AHP), Metode Elimination Et Choix Traduisant la Réalité (Electre), Metode Evaluation Based On Distance From Average Solution (EDAS), Metode Multi-Attributive Border Approximation Area Comparison (MABAC), Konsep Group Decision Support System  (GDSS), dan Metode Fuzzy.",
    "Buku 35": "penyusunan neraca energi untuk sistem tertutup maupun sistem terbuka (steady-state flow system), Fenomena tekanan uap zat murni, Persamaan Antoine dan Persamaan Wagner, Karakteristik gas ideal, penyimpangan gas nyata melalui Persamaan Virial, penerapan berbagai Persamaan Keadaan (EOS - Equation of State), kesetimbangan fase uap-cair, pemodelan VLE sederhana menggunakan Hukum Raoult untuk menghitung titik embun (dewpoint) dan titik gelembung (bubblepoint), Persamaan Margules, Wilson, NRTL, dan UNIQUAC, Kesetimbangan Cair-Cair / LLE.",
    "Buku 36": "",
    "Buku 37": "akuntansi perpajakan, akuntansi komersial dengan akuntansi pajak, membahas konsep pembukuan dan pencatatan dalam perpajakan, perhitungan, dan pencatatan akuntansi untuk PPh, pajak atas penghasilan karyawan atau pegawai. membahas definisi, objek, pemungutan, perhitungan, dan pencatatan akuntansi PPh, penghasilan seperti jasa, dividen, royalti, dan sewa, kredit pajak luar negeri, sumber penghasilan dari luar negeri, prosedur penyetoran dan pelaporan pajak standar akuntansi PSAK dasar hukum Pajak Pertambahan Nilai (PPN) dan PPnBM,",
    "Buku 42": "",
    "Buku 21 09.25.47": "",
}
...
def extract_keywords_from_index_file(gt_path):
    ...
    for page in doc:
        ...
        for line in lines:
            if len(line.strip()) <= 1 or line.lower() == "indeks":
                continue
                
            match = re.match(r'^([A-Za-z][A-Za-z\s\-\(\)]*?)\s*(?:[\d·,])', line.strip())
...
if __name__ == "__main__":
    ...
    for folder in folders:
        ...
        try:
            ...
            # ---> PENYESUAIAN FAIR EVALUATION (MEMOTONG MATCHED_KEYWORDS SEBANYAK GROUND TRUTH) <---
            if indeks_pdf:
                ground_truth_keywords = extract_keywords_from_index_file(indeks_pdf)
                target_limit = len(ground_truth_keywords)
                print(f"  -> [FAIR EVALUATION] Menyamakan target ekstraksi dengan indeks asli: {target_limit} kata kunci.")
                
                # Memotong list hasil (yang sudah diurutkan skor kemiripannya)
                if target_limit > 0:
                    matched_keywords = matched_keywords[:target_limit]
